...
@Module({
  ...
  controllers: [], // Remove AppController from the controllers array
  providers: [
    // Remove AppService from the providers array
    {
      provide: APP_FILTER,
...
export class TestModule {} // Rename the module class to TestModule
